...
#define STRING_CONFIG_H_AUTHOR "(Sven Hoth, Anet config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define DEFAULT_bedKp 389.06
  //#define DEFAULT_bedKi 52.19
  //#define DEFAULT_bedKd 725.06
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 94.78 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.65   // Z offset: -below +above  [the nozzle]
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 280.20
  #define XY_DIAG_BD 284.20
  #define XY_SIDE_AD 199.50

  // Or, set the default skew factors directly here
  // to override the above measurements:
  // #define XY_SKEW_FACTOR -0.014175
